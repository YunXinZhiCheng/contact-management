...
<div>
  ...
  <div class="form">
    <label for="name">
      <span>姓名：</span>
      <input :class="className.name" type="text" id="name" :disabled='edit' />
      <em v-show="nameIn">*姓名不能为空且只能由字母、数字、下划线组成</em>
    </label>
    <label for="tel">
      <span>电话号码：</span>
      <input :class="className.tel" type="text" id="tel" :disabled='edit' />
      <em v-show="telIn">*不能为空且全部为数字</em>
    </label>
    <label for="psw">
      <span>密码：</span>
      <input :class="className.psw" type="text" id="psw" :disabled='edit' />
